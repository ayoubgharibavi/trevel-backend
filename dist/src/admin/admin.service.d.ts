...
export declare class AdminService {
    ...
    constructor(prisma: PrismaService, flightsService: FlightsService, configService: ConfigService, accountingService: AccountingService, accountingSetup: AccountingSetupService);
    ...
    forceUpdateBookingSource(bookingId: string, source: string): Promise<{
        success: boolean;
        message: string;
        booking: {
            id: string;
    ...
    createFlight(creatorId: string, createFlightDto: CreateFlightDto): Promise<{
        id: string;
        airline: any;
    ...
    adminReplyToTicket(adminId: string, ticketId: string, message: string, sendChannels: any): Promise<{
        success: boolean;
        data: {
            id: string;
            subject: string;
    ...
    chargeUserWallet(userId: string, amount: number, currency: string, description: string): Promise<{
        success: boolean;
        message: string;
    }>;
    ...
    updateContent(data: any): Promise<{
        success: boolean;
        message: string;
    }>;
