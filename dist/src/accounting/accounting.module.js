...
const accounting_initialization_service_1 = require("./accounting-initialization.service");
...
exports.AccountingModule = AccountingModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [accounting_service_1.AccountingService, accounting_setup_service_1.AccountingSetupService, accounting_initialization_service_1.AccountingInitializationService],
        exports: [accounting_service_1.AccountingService, accounting_setup_service_1.AccountingSetupService]
    })
], AccountingModule);
